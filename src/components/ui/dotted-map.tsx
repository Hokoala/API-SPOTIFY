...
export const DottedMap = React.memo(function DottedMap({
  ...
  // Memoize the base map generation — expensive with high mapSamples
  ...
  // Pre-compute dot positions to avoid recalculation in render
  const dotElements = React.useMemo(() =>
    ...
    }), [points, yToRowIndex, stagger, xStep, dotRadius]
  )
